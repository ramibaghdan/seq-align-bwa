...
| File | What it is |
|---|---|
| `Alignment_CountAssem` | Bash code used to align reads to the reference genomes and count assembled reads for each alignment |
...
| `assembled_per_indGM.txt` | Counts of raw and assembled reads using *Gadus morhua* as the reference genome |
| `assembled_per_indNBG.txt` | Counts of raw and assembled reads using the new burbot genome as the reference |
| `Count_assembled.Rmd` | R Markdown script comparing assembled counts and percentages for the two alignments |
